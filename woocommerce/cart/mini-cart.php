...
<?php if (!WC()->cart->is_empty()) : ?> 
                        ...
                        <div class="remove col-2 text-end">
                            <?php echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                ...
                                sprintf(
                                    ...
                                    esc_attr__('Remove this item', 'z-platform'),
                                    esc_attr($product_id),
    ...
    <div class="cart-footer bg-light text-center p-3">
        ...
        <p class="text-muted small shipping-text"><?php esc_html_e('To find out your shipping cost, please proceed to checkout.', 'z-platform'); ?></p>
...
<?php else : ?>
    ...
    <p class="woocommerce-mini-cart__empty-message alert alert-info m-3"><?php esc_html_e('No products in the cart.', 'z-platform'); ?></p>
