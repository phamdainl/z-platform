...
<div class="col-sm-<?php echo esc_attr($display_single_blog_columns); ?> mb-5 article">
    <div class="article_style bg-white">   
		...
		<?php if (has_post_thumbnail( $post->ID ) ): ?>
            ...
            <a class="blog_image_url customize-unpreviewable" href="<?php esc_url(the_permalink()); ?>"><img alt="<?php the_title();?>" width="540" height="303" src="<?php echo esc_url($image[0]); ?>"></a>
