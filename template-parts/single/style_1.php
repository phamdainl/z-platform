...
?>
	...
	<div class="single_style_1 page-head">		

		<?php if (has_post_thumbnail( $post->ID ) ): ?>
            <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'full' ); ?>
            
				<div class="single_1_bg" style="background-image: url('<?php echo esc_attr($image[0]); ?>')"></div>
		...
		<div class="container position-relative">
			...
			<div class="col-12">
				...
				<h1 class="single_style_1_title"><?php the_title();?></h1>
